class ResumesController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to resumes_path, notice: "This is not your resume! You can make changes to only your resume!" if @resume.nil?
  end
  ...
  private
    ...
    def resume_params
      params.require(:resume).permit(:first_name, :last_name, :email, :phone, :linkedin, :github, :address, :educational_qualifications, :skills, :cirtificates, :projects, :experience, :user_id)
    end
end
